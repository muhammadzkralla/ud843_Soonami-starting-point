    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e("First Error", String.valueOf(e));
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                Log.e("Second Error", String.valueOf(e));
         ...
         */
        public   Event extractFeatureFromJson(String earthquakeJSON) {
            ...
            try {
                ...
                for (int i = 0;i < featureArray.length();i++){
                    ...
                    Event output = new Event(title, time, tsunamiAlert);
